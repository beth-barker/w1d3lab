...
/*
  ...
  If it is 80 degrees or above, and raining, one should wear a t-shirt and take an umbrella. If it is between 60 and 80 degrees, and raining, one should wear a rain-jacket. If it is 60 degrees
   or below, one should wear a jacket and carry an umbrella. Come up with your own clothing suggestions based on those temperature parameters when it is not raining.
*/
...
if(temperature > 80 && rain === true){
  ...
  console.log('Wear and jacket and carry an umbrella.')
} else if(temperature > 80 && rain != true){
  console.log('Wear a tank top.')
} else if (temperature > 60 && temperature < 80 && rain != true) {
  console.log('Bring a jacket and leave umbrella at home.')
} else {
  console.log('Wear a coat and leave umbrella at home.')
}
